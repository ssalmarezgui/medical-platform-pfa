...
import { 
  ...
  IconUserCheck, IconAlertCircle, IconEdit, IconFileSpreadsheet, IconDatabaseImport, IconX, IconLoader, IconDownload, IconFolderOpen, IconLock
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[500px] text-center p-8 bg-white border border-red-100 rounded-[30px] shadow-sm max-w-lg mx-auto mt-12 text-xs">
        ...
        <p className="text-[#6588BB] text-sm leading-relaxed mb-6">
          La saisie et l'évaluation de l'arbre génétique ainsi que le dépistage des néphropathies familiales d'origine sont strictement réservés aux praticiens d'investigation et de suivi.
        </p>
      </div>
    );
  }
